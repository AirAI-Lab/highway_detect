...
class DinkNet34_less_pool(nn.Module):
    def __init__(self, num_classes=1):
        ...
        resnet = load_resnet34_backbone(pretrained=True, caller='NLlinkNet.DinkNet34_less_pool')
...
class NLinkNet34(nn.Module):
    def __init__(self, num_classes=1):
        ...
        resnet = load_resnet34_backbone(pretrained=True, caller='NLlinkNet.NLinkNet34')
        self.firstconv = resnet.conv1
        self.firstbn = resnet.bn1
        self.firstrelu = resnet.relu
        self.firstmaxpool = resnet.maxpool
...
class DinkNet50(nn.Module):
    def __init__(self, num_classes=1):
        ...
        resnet = load_resnet_backbone('resnet50', pretrained=True, caller='NLlinkNet.DinkNet50')
        self.firstconv = resnet.conv1
        self.firstbn = resnet.bn1
        self.firstrelu = resnet.relu
        self.firstmaxpool = resnet.maxpool
...
class DinkNet101(nn.Module):
    def __init__(self, num_classes=1):
        ...
        resnet = load_resnet_backbone('resnet101', pretrained=True, caller='NLlinkNet.DinkNet101')
        self.firstconv = resnet.conv1
        self.firstbn = resnet.bn1
        self.firstrelu = resnet.relu
        self.firstmaxpool = resnet.maxpool
...
class LinkNet34(nn.Module):
    def __init__(self, num_classes=1):
        ...
        filters = [64, 128, 256, 512]
        # Prefer local ResNet34 weights; fall back if unavailable
        resnet = load_resnet34_backbone(pretrained=True, caller='NLlinkNet.LinkNet34')
...
if __name__ == '__main__':
    ...
    model = LinkNet34()
    # net = Model(img_size=1024)
    # input = torch.randn(1, 3, 1024, 1024)
    macs, params = get_model_complexity_info(model, (3, 1024, 1024), as_strings=True, print_per_layer_stat=True,
                                             verbose=True)
    print('flops:', macs)
    print('params:', params)