...
class DinkNet34_less_pool(nn.Module):
    def __init__(self, num_classes=1, pretrained: bool = False):
        ...
        # Prefer local ResNet34 weights only when requested via flag; otherwise random-init
        resnet = load_resnet34_backbone(pretrained=bool(pretrained), caller='Nlinknet.DinkNet34_less_pool')
...
class NLinkNet34(nn.Module):
    def __init__(self, num_classes=1, num_channels=3, pretrained: bool = False):
        ...
        resnet = load_resnet34_backbone(pretrained=bool(pretrained), caller='Nlinknet.NLinkNet34')
...
class DinkNet50(nn.Module):
    def __init__(self, num_classes=1, pretrained: bool = False):
        ...
        # Load local weights only when requested; otherwise random-init
        resnet = load_resnet_backbone('resnet50', pretrained=bool(pretrained), caller='Nlinknet.DinkNet50')
        self.firstconv = resnet.conv1
        self.firstbn = resnet.bn1
        self.firstrelu = resnet.relu
        self.firstmaxpool = resnet.maxpool
...
class DinkNet101(nn.Module):
    def __init__(self, num_classes=1, pretrained: bool = False):
        ...
        filters = [256, 512, 1024, 2048]
        # Load local weights only when requested; otherwise random-init
        resnet = load_resnet_backbone('resnet101', pretrained=bool(pretrained), caller='Nlinknet.DinkNet101')
        self.firstconv = resnet.conv1
        self.firstbn = resnet.bn1
        self.firstrelu = resnet.relu
        self.firstmaxpool = resnet.maxpool
...
class LinkNet34(nn.Module):
    def __init__(self, num_classes=1, pretrained: bool = False):
        ...
        filters = [64, 128, 256, 512]
        # Prefer local ResNet34 weights only when requested via flag; otherwise random-init
        resnet = load_resnet34_backbone(pretrained=bool(pretrained), caller='Nlinknet.LinkNet34')
